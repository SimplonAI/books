...
class Books(Base):
    ...
    original_publication_year = Column(
        "book_original_publication_year", Integer, nullable=True
    )
    ...
    work_text_reviews_count = Column(
        "book_work_text_reviews_count", Integer, nullable=False
    )
...
class BooksTags(Base):
    ...
    goodreads_book_id = Column(
        "goodreads_book_id",
        ForeignKey("books.book_goodreads_book_id"),
        primary_key=True,
    )
